image::https://github.com/spring-cloud/spring-cloud-openfeign/workflows/Build/badge.svg?style=svg["Build",link="https://github.com/spring-cloud/spring-cloud-openfeign/actions"]
