...
|feign.eager-load.enabled | `false` | Enables eager load for Feign clients.
|feign.eager-load.clients | | Comma separated list with client names, which should be instantiated eagerly
