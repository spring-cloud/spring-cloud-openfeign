...
You can modify this behaviour to derive the charset from the `Content-Type` charset instead by setting the value of `feign.encoder.charset-from-content-type` to `true`.
