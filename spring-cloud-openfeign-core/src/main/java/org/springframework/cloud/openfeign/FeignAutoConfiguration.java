	...
	protected static class AsyncHttpClient5FeignConfiguration {
		...
		public AsyncClientConnectionManager connectionManager(FeignHttpClientProperties httpClientProperties,
			...
			return PoolingAsyncClientConnectionManagerBuilder.create()
					...
					.setConnPoolPolicy(PoolReusePolicy.LIFO).setConnectionTimeToLive(TimeValue
							.of(httpClientProperties.getTimeToLive(), httpClientProperties.getTimeToLiveUnit()))
					.build();
		}
		...
		public CloseableHttpAsyncClient httpClient(AsyncClientConnectionManager connectionManager,
				FeignHttpClientProperties httpClientProperties) {
			final org.apache.hc.client5.http.config.RequestConfig defaultRequestConfig = org.apache.hc.client5.http.config.RequestConfig
					.custom()
